...
| Salesforce Opportunities | `account_name`, `stage`, `amount`, `close_date`, `contract_term_months` | Pipeline-quality analysis | Not yet wired into live dashboard | Implementation is still pending |
| Product Events | product telemetry fields | Customer health scoring, cohort analysis | Not yet implemented  | Not yet implemented |
