...
| # | Assumption | Rationale | Impact if Wrong | Date |
|---|-----------|-----------|----------------|------|
| 1 | Region inference can fall back from website/domain matching to exact normalized company-name matching. | Many sample records align better by company name than by billing email domain or CRM website. | Similar company names could be over-merged until stable foreign keys exist. | 2026-04-16 |
